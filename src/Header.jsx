            ...
            <div className="col-lg-9 col-md-9">
              <div className="header_right_info">
                ...
                <div className="shopping_cart">
                  <a href="#" onClick={() => setCartShow(!cartShow)}><i className="fa fa-shopping-cart" /> 2SP - 238.000đ <i className="fa fa-angle-down" /></a>
                  {/*mini cart*/}
                {
                  cartShow && (
                ...
                <div className="main_menu d-none d-lg-block">
                  <nav>
                    ...
                    <li className={location.pathname == '/' ? 'active' : ''}>
                      ...
                      <li className={location.pathname == '/about-us' ? 'active' : ''}><Link  to={'/about-us'}>GIỚI THIỆU</Link>
                    ...
                    ><Link to={'/policy'}>QUY ĐỊNH THUÊ</Link>
                      ...
                      <li  className={location.pathname == '/contact' ? 'active' : ''}><Link to={'/contact'}>LIÊN HỆ</Link>                   
                      </li>
                    </ul>
                  </nav>
                </div>
